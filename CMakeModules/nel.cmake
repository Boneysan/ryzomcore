...
MACRO(NL_SETUP_BUILD)
  ...
  # Phase 0: C++17 is now enforced at root CMakeLists.txt for the whole project.
  # This block keeps compatibility notes but does not downgrade.
  if(CMAKE_CXX_COMPILER_ID STREQUAL "GNU" AND CMAKE_CXX_COMPILER_VERSION VERSION_GREATER_EQUAL 9)
    # Root already set 17; ensure here for subdirs if needed
  ...
  elseif(MSVC AND MSVC_VERSION GREATER_EQUAL 1920)
    if(NOT CMAKE_CXX_STANDARD OR CMAKE_CXX_STANDARD LESS 17)
      set(CMAKE_CXX_STANDARD 17)
      set(CMAKE_CXX_STANDARD_REQUIRED ON)
    endif()
    ...
    set(CMAKE_C_STANDARD_REQUIRED ON)
    set(NL_CPP_STANDARD_SET ON)
  elseif(CMAKE_CXX_COMPILER_ID MATCHES "Clang" AND CMAKE_CXX_COMPILER_VERSION VERSION_GREATER_EQUAL 5)
    # Clang (incl. AppleClang) has had full C++17 support since Clang 5.
    if(NOT CMAKE_CXX_STANDARD OR CMAKE_CXX_STANDARD LESS 17)
      set(CMAKE_CXX_STANDARD 17)
      set(CMAKE_CXX_STANDARD_REQUIRED ON)
    endif()
    ...
    # Old compilers: fail early (Phase 0 requires modern toolchain)
    message(FATAL_ERROR "Phase 0 Foundation requires GCC >=9, Clang >=5, or MSVC >=2019 for C++17. Update your compiler or use a dev container/CI image.")
  endif()
